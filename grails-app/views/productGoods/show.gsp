			...
			<ol class="property-list productGoods">
				...
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="productGoods.category.label" default="Category" /></span>
						...
						<span class="property-value" aria-labelledby="category-label"><g:link controller="productCategory" action="show" id="${productGoodsInstance?.category?.id}">${productGoodsInstance?.category?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="brand-label" class="property-label"><g:message code="productGoods.brand.label" default="Brand" /></span>
						...
						<span class="property-value" aria-labelledby="brand-label"><g:link controller="brand" action="show" id="${productGoodsInstance?.brand?.id}">${productGoodsInstance?.brand?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="xthumbnail-label" class="property-label"><g:message code="productGoods.xthumbnail.label" default="Xthumbnail" /></span>
						...
						<span class="property-value" aria-labelledby="xthumbnail-label"><g:fieldValue bean="${productGoodsInstance}" field="xthumbnail"/></span>
				...
				<li class="fieldcontain">
					<span id="ximage1-label" class="property-label"><g:message code="productGoods.ximage1.label" default="Ximage1" /></span>
						...
						<span class="property-value" aria-labelledby="ximage1-label"><g:fieldValue bean="${productGoodsInstance}" field="ximage1"/></span>
				...
				<li class="fieldcontain">
					<span id="ximage2-label" class="property-label"><g:message code="productGoods.ximage2.label" default="Ximage2" /></span>
						...
						<span class="property-value" aria-labelledby="ximage2-label"><g:fieldValue bean="${productGoodsInstance}" field="ximage2"/></span>
				...
				<li class="fieldcontain">
					<span id="ximage3-label" class="property-label"><g:message code="productGoods.ximage3.label" default="Ximage3" /></span>
						...
						<span class="property-value" aria-labelledby="ximage3-label"><g:fieldValue bean="${productGoodsInstance}" field="ximage3"/></span>
				...
				<li class="fieldcontain">
					<span id="xishot-label" class="property-label"><g:message code="productGoods.xishot.label" default="Xishot" /></span>
						...
						<span class="property-value" aria-labelledby="xishot-label"><g:formatBoolean boolean="${productGoodsInstance?.xishot}" /></span>
				...
				<li class="fieldcontain">
					<span id="xquantity-label" class="property-label"><g:message code="productGoods.xquantity.label" default="Xquantity" /></span>
						...
						<span class="property-value" aria-labelledby="xquantity-label"><g:fieldValue bean="${productGoodsInstance}" field="xquantity"/></span>
